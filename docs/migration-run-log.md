...
| 025 | `025_policy_impact_check.sql` | ☐ | Hands recent applications to the rules engine so a proposed change can be run beside the live one, and keeps the result |
