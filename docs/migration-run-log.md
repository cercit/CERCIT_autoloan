...
| 031 | `031_foir_ltv_tenure_basis.sql` | ☐ to run | FOIR on net salary plus other income (as the rules use); summary names ex-showroom and on-road LTV; tenure capped at the tightest of product and band limits, and a cut that pushes FOIR over the cap goes to review |
