...
| 028 | `028_facts_use_assessed_emi.sql` | ☐ | The impact check uses the EMI, amount and tenure the assessment settled on, so the affordability rules are actually exercised |
