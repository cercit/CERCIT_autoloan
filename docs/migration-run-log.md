...
| 030 | `030_decision_version_pinning.sql` | ☐ to run | Every recommendation and decision records the policy version, the exact rule set and the model version it was made under; older rows are marked 2026.08 (assumed) |
